...
export class NewComment extends Component{
    ...
    <div className="col-md-4 forum-report"><input type="submit" className="getstarted-button" value="Post Reply" onClick={()=>this.postComment()}/></div>
...
export default connect(mapper)(NewComment);